package com.ohgiraffers.stream.second;
...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        List<String> completedOrderIds = orders.stream()
                .filter(status -> "배송 완료".equals(status.getStatus()))
        ...
        Map<String, Double> totalAmountByCustomer = orders.stream()
                .sorted(Comparator.comparing(Order::getTotalAmount, Comparator.reverseOrder()))
        ...
        System.out.println(totalAmountByCustomer);
                ...
                String highestOrderCustomer = String.valueOf(orders.stream()
