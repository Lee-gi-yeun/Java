...
public class Application3 {
    public static void main(String[] args) {
        ...
        long longAg = 100L;
        application3.testMethod((int)longAg);

        application3.testMethod2("asdf",25,'남');
    }
    ...
    public void testMethod2(String name, int age, final char gender){
        // 매개변수도 일종의 지역변수(local variable)이다
        // 단, 상수 네이밍 규칙을 선택적으로 따르는 경향이 있다.
        name = "홍길동";
        age = 20;
//        gender = '여';
        System.out.println("당신의 이름은 " + name + "이고 당신의 나이는 " + age + "세이며 성별은 "+ gender + "입니다");
    }
}
